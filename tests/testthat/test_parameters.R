...
test_that('proportion_parameter_array', {
  ...
  expect_error(proportion_parameter_array('test', c(Inf, 0.1, 0.2), 
    letters[1:3]))
  expect_error(proportion_parameter_array('test', value=c(NA_real_, 0.1, 0.2),
    row.names=letters[1:3]))
  expect_error(proportion_parameter_array('test', value=c(0L, 0L, 0L),
    row.names=letters[1:3]))
  expect_error(proportion_parameter_array('test', value=c(5, 0.1, 0.2),
    row.names=letters[1:3]))
